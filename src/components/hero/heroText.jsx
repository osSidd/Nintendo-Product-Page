...
export default function HeroText(){
    return(
        <div className='w-full md:w-5/12 mt-8 lg:mt-0 md:pl-10'>
            ...
            <h1 className=' text-footer-heading text-xl lg:text-3xl font-bold mt-4 lg:mt-6'>Stardew Valley</h1>
            <div className='flex justify-between mt-2 lg:mt-6'>
                <span className=' text-footer-heading text-2xl font-bold'>$14.99</span>
            ...
            <div className='flex items-center mt-4 lg:mt-8'>
                ...
                <small className='text-footer-heading'>Eligible for up to <span className='font-bold'>75</span> Gold Points</small>
            </div>
            <DownloadBtn mt='mt-6' lgMt='mt-8' px='px-4' py='py-4' text='xs:text-lg' rounded='rounded-xl'/>            
            <div className='mt-2 text-center lg:text-left'>
                <small className='text-footer-heading'>This item will be sent to your system automatically after purchase.</small>
            </div>
        </div>
    )
}