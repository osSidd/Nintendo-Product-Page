...
export default function EsrbRating({shadow, pl, py}){
    return (
        <a className={`flex flex-col lg:flex-row items-center bg-white ${py} pr-2 lg:${pl} lg:pr-14 rounded-xl ${shadow}`} href="https://www.esrb.org/ratings-guide/" rel="noreferrer" target="_blank">
