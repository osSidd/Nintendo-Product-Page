...
export default function Online(){
    return(
        <div className='bg-online flex flex-col lg:flex-row rounded-2xl px-8'>
            <div className='mt-8'>
                <img src={online} alt="online" />
                <p className='mt-8 text-xl font-bold text-footer-heading'>
                ...
                <a href="https://www.nintendo.com/us/switch/online/" target='_blank' rel='noreferrer'><button className='mt-6 bg-main text-white px-5 py-3 rounded-xl text-lg font-bold'>Learn more</button></a>
            </div>
