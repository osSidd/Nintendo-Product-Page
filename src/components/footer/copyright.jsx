...
export default function Copyright(){
    ...
    const linkClassStr = `
            ...
            transition-all duration-1000 ease-in-out lg:whitespace-nowrap text-copyright-links-mobile md:text-xs
        `

    return(
        <section className='w-full h-80 lg:h-auto  flex flex-col lg:flex-row items-center lg:justify-between px-4 py-8 bg-footer-bg'>
            <small className='md:w-5/12 xl:w-6/12 text-center lg:text-left text-copyright-address text-copyright-links-mobile md:text-sm lg:text-xs'>
            ...
            <div className='mt-4 lg:mt-0 flex flex-row justify-end items-center lg:w-7/12'>
                {
